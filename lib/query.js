...
var query = {
  ...
  /**
   * Set up the query object by intialising some data, and guessing the type as
   * a 'find'. This is altered by certain methods. Once the type has been set it
  ...
  /**
   * Generic find. This doesn't affect the query and is just passed-through.
   */
  find: function () {
    return this;
  },
